...
export function updateRefillEnergy(username: string, refill_energy: number, refill_energy_date: Date) {
    return async () => {
        try {
...
export function updateDoublePoints(username: string, double_points: number, double_points_date: Date) {
    return async () => {
        try {
