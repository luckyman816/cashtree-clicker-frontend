                ...
                <div className="flex flex-col justify-center items-center w-full gap-2">
                    <div className="flex justify-start items-center w-[90%] text-white text-xl font-bold">All Level</div>
                    {
                        levels.map((item, index) => (
                            <div
                                key={index}
                                className={`flex w-[90%] my-3 px-3 py-2 items-center justify-between bg-[linear-gradient(315deg,_var(--tw-gradient-stops))] from-[#6929F1] to-[#A944FD] hover:bg-[linear-gradient(0.5turn, #711CD9, #CD3CFB)]  rounded-[20px] gap-2 border border-[#B286FA]`}>
