        ...
        <div className=" overflow-y-auto w-full max-h-[50vh]">
          <div className="flex flex-col justify-center items-center w-full">
            ...
            {dailyCheckItems.map((item, index) => (
              <div
                key={index}
                className={`w-[90%] my-[6px]  bg-[linear-gradient(315deg,_var(--tw-gradient-stops))] from-[rgba(255, 255, 255, 0.02)] to-[rgba(255, 255, 255, 1)] hover:bg-[linear-gradient(0.5turn, #711CD9, #CD3CFB)]  rounded-[20px] border`}
