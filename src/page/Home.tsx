  ...
  return (
    <div className="flex flex-col justify-between items-center h-full w-full">
      ...
      <div className="w-[90%] flex flex-col justify-center items-center gap-4">
        ...
        <div className="flex justify-between items-center w-full px-3 bg-[linear-gradient(315deg,_var(--tw-gradient-stops))] from-[#7B34EF] to-[#2A0E58] rounded-[10px] border border-[#B386FB]">
