...
const Onboarding = () => {
    ...
    return (
        <div className=" relative w-screen h-screen flex flex-col justify-center items-center bg-[linear-gradient(0deg,_var(--tw-gradient-stops))] from-[#120F29] to-[#7F3AEF] py-5" >
            ...
            <div className="w-full h-full justify-end items-center flex flex-col gap-1 z-20 px-[30px] pb-[80px]">
                ...
                {
                    pageNum == 5 ?
                        <Link to={"/home"} className="w-[80%] flex justify-center items-center text-white rounded-[20px] bg-[#7520FF] h-[56px] py-4">
                            <span className="text-white text-xl">Start game</span>
                        </Link>
                        :
                        <div className="w-[80%] flex justify-center items-center text-white rounded-[20px] bg-[#7520FF] h-[56px] py-4" onClick={handleNext}>
