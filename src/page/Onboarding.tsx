    ...
    return (
        <div className=" relative w-screen h-screen flex flex-col justify-around items-center bg-[linear-gradient(0deg,_var(--tw-gradient-stops))] from-[#120F29] to-[#7F3AEF]" >
            ...
            <div className="w-full justify-center items-center flex z-20">
                {pageNum == 1 ? <img src="/image/onboarding/onboarding_1.png" alt="" className="w-[80%] h-auto" />
                    : pageNum == 2 ? <img src="/image/onboarding/onboarding_2.png" alt="" className="w-[80%] h-auto" />
                        : pageNum == 3 ? <img src="/image/onboarding/onboarding_3.png" alt="" className="w-[80%] h-auto" />
                            : pageNum == 4 ? <img src="/image/onboarding/onboarding_4.png" alt="" className="w-[80%] h-auto" /> :
                                <img src="/image/onboarding/onboarding_5.png" alt="" className="w-[80%] h-auto" />}

            </div>
            <div className="w-full justify-center items-center flex flex-col gap-2 z-20 flex-grow">
                {pageNum == 1 ?
                    <div className="w-[80%] h-[320px] flex flex-col justify-end items-end gap-2">
                    ...
                    : pageNum == 2 ?
                        <div className="w-[80%] h-[320px] flex flex-col justify-end items-end gap-2">
                            <h1 className="text-white text-[40px] text-left">Understanding The Game Rules</h1>
                        ...
                        : pageNum == 3 ?
                            <div className="w-[80%] h-[320px] flex flex-col justify-end items-end gap-2">
                                <h1 className="text-white text-[40px] text-left">The Rewards and The Milestones</h1>
                            ...
                            : pageNum == 4 ?
                                <div className="w-[80%] h-[320px] flex flex-col justify-end items-end gap-2">
                                    <h1 className="text-white text-[40px] text-left">Purchase Your One-Time Entry Fee</h1>
                                ...
                                : <div className="w-[80%] h-[320px] flex flex-col justify-end items-end gap-2">
                                    <h1 className="text-white text-[40px] text-left">Trying the Demo Mode First</h1>
